# <img src="public/csv.png" style="vertical-align: text-bottom" > CSV Custom Fields Shopify App
...
2. **Edit Fields**
   - Customize the **CSV** fields according to your desired settings.

3. **Combine Fields**
   - Merge fields such as product price and quantity into a single field.

4. **Download CSV**
   - Export the updated **CSV** file after editing.

![image](public/template-manager.png)
...
- All settings support **CRUD** (Create, Read, Update, Delete) operations.
- Application settings are stored in a **SQLite** database.
